...
class OmniVisitor(NodeVisitor, MaterialVisitor, MaterialMappingVisitor, TextureVisitor, TextureMappingVisitor, MeshVisitor):
    __swig_setmethods__ = {}
    for _s in [NodeVisitor, MaterialVisitor, MaterialMappingVisitor, TextureVisitor, TextureMappingVisitor, MeshVisitor]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
...
class GLRenderer(NodeVisitor, MaterialVisitor, TextureVisitor):
    __swig_setmethods__ = {}
    for _s in [NodeVisitor, MaterialVisitor, TextureVisitor]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
